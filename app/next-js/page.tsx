...
const notifications = [
    {
        title: "Start Date: 15th, Jan, 2024",
        ...
        <div className='max-w-7xl mx-auto pt-5'>
            ...
            <Card className={cn("max-w-[580px]")}>
                <CardHeader>
                    ...
                    <CardDescription>
                        NEXT.JS ကိုလေ့လာဖို့ HTML, CSS, JS, React.js ကို သိထားပြီးသူများမှ လေ့လာနိုင်မှာဖြစ်ပြီး Free 4 U ရဲ့ Batch 1 မှာ Web Development ကိုစတင်သူများအတွက် မယ်သည့် ပညာရပ်တွေကို စတင်ရှာဖွေလေ့လာရမှာလဲ စတာတွေကို ပြောပြပေးမှာဖြစ်တယ်။
                        HTML, CSS, JS, React.JS Home Page ရဲ့ <Link className='underline' href={'/'}>Learn Section</Link> မှာလေ့လာနိုင်တယ်။
                    </CardDescription>
                </CardHeader>
